...
// console.log(transverArr([1,2,3,4,5,6,7],3));
...
// console.log(arraySort([8, 9, 6, 4, 9, 7]))
...
// console.log(nonZeroMove([0, 0, 0, 1, 0, 2, 0, 3]))
...
// console.log(findUnique([1,2,3,4,3]))
...
// console.log(findDuplicate([1,2,3,4,5,2,5,6,4,7]));
...
console.log(findUniques([2,3,4,5,2,1,4,5,3]));
